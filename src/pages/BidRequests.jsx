                ...
                <tbody className="bg-white divide-y divide-gray-200 ">
                  {bids.map((bid) => (
                    <tr key={bid._id}>
                      ...
                      {/* ////////////////////////////////////////////////////=========== */}
                      <td className="px-4 py-4 text-sm whitespace-nowrap">
                        {/* accept button aita In progress hobe */}
                        <button
                          onClick={() =>
                        ...
                        {/* accept button aita reject hobe */}
                        ...
                        <button
                          ...
                          disabled={bid.status === "Complete"}
                          title="Mark Complete"
                          className=" ml-2 text-gray-500 transition-colors duration-200   hover:text-red-500 focus:outline-none disabled:cursor-not-allowed"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                          ...
                          >
                            <path
                              ...
                              d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18zM8 8l8 8"
                            />
                          </svg>
                        </button>
                      </td>
